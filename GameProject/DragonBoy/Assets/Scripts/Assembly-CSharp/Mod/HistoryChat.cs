...
namespace Mod
{
    public class HistoryChat
    {
        ...
        public void append(string text)
        {
            ...
            try
            {
                histories = JsonConvert.DeserializeObject<List<string>>(
                        File.ReadAllText(Utils.PathChatHistory));
            }
            catch { }
            if (histories == null)
            ...
            try
            {
                File.WriteAllText(Utils.PathChatHistory,
                    JsonConvert.SerializeObject(histories, Formatting.Indented));
            }
            catch { }
        }
